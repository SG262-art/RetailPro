...
-- RESOLUCIÓN DE CONSULTAS DE NEGOCIO

-- Consulta 1: Exploración general de la tabla sales

SELECT * -- NOTA TÉCNICA: Se utiliza SELECT * únicamente para inspección inicial en desarrollo.
FROM sales;
...
-- Consulta 3: Selección con alias en español.
